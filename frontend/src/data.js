...
//pb:
//return all items whose status is not equal to suggestion
//1 iterate over rd and display data whose status != suggestion. avoid duplicate

//2 on click display data whose status match header

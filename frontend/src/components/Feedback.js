...
const Feedback = () => {
...

  {
    return suggestions.map((suggestion) => {
      return (
        <Link key={suggestion._id} to="/feedbackdetail">
          <div className="bg-white w-327 h-200 tablet:h-151 tablet:w-689 desktop:w-825 rounded-default p-6 feedback_cont">
            <div className="feedback_content_cont">
              ...
              <div
                className="ux-tag h-7 rounded-default bg-Cotton-Ball text-center text-body-3 font-semibold text-The-Rainbow-Fish flex items-center justify-center hover:bg-Pale-Phthalo-Blue transition-colors duration-500 cursor-pointer active:bg-The-Rainbow-Fish mb-4 capitalize
        "
              >
                {suggestion.category}
              </div>

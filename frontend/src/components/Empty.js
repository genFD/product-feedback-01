...
const Empty = () => {
  return (
    <div className="px-6 h-460 tablet:px-0 tablet:h-600 tablet:w-689 desktop:w-825">
      <div className="bg-white w-full h-full justify-center items-center flex flex-col rounded-default">
        <svg
          className="mb-11"
          width="102"
          height="108"
        ...
        <h2 className=" text-Raven-Night font-bold text-heading-3 text-center mb-3">
          There is no feedback yet.
        </h2>
        <p className=" max-w-xs text-Ocean-Night font-normal text-body-3 text-center mb-6">

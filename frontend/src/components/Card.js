...
const Card = ({ request }) => {
  return (
    <div
      key={request.id}
      className={`roadmap_card w-full h-233 tablet:pb-6 tablet:h-251 pt-6 bg-white rounded-default after:content-[''] after:absolute after:w-full after:h-6 after:top-0 after:rounded-t-default ${
